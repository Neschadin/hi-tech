...
export const LandingHero = () => (
  <section className="relative mx-auto min-h-130 max-w-[1920px] overflow-hidden md:min-h-145">
    <HeroBg />

    <Container className="min-h-70 flex-col items-center justify-center py-10 md:min-h-76 md:py-14">
      ...
      <p className="mb-8 max-w-164.75 text-center text-lg font-medium md:text-2xl">
